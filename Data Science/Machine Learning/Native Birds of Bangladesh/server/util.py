...
if __name__ == '__main__':
    ...
    print(classify_image(None, "C:\\Users\\Sumit\\Jupyter Code\\Native Birds of Bangladesh\\Train\\Asian-Koel_(Kokil)\\Asian-Koel_(Kokil)80.jpg"))
